package com.siemens.blufi.response;
...
public class BlufiStatusResponse {
    ...
    public String toString() {
        return "BlufiStatusResponse{" +
                "mOpMode=" + mOpMode +
                ", mSoftAPSecurity=" + mSoftAPSecurity +
                ", mSoftAPConnCount=" + mSoftAPConnCount +
                ", mSoftAPMaxConnCount=" + mSoftAPMaxConnCount +
                ", mSoftAPChannel=" + mSoftAPChannel +
                ", mSoftAPPassword='" + mSoftAPPassword + '\'' +
                ", mSoftAPSSID='" + mSoftAPSSID + '\'' +
                ", mStaConnecionStatus=" + mStaConnecionStatus +
                ", mStaBSSID='" + mStaBSSID + '\'' +
                ", mStaSSID='" + mStaSSID + '\'' +
                ", mStaPassword='" + mStaPassword + '\'' +
                '}';
    }
}
