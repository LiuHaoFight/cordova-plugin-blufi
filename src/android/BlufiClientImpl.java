...
import com.siemens.blufi.security.BlufiAES;
import com.siemens.blufi.security.BlufiCRC;
import com.siemens.blufi.security.BlufiDH;
import com.siemens.blufi.security.BlufiMD5;
...
public class BlufiClientImpl implements BlufiParameter {
    ...
    public void postCustomData(final byte[] data) {
        mThreadPool.submit(new ThrowableRunnable() {
            @Override
            void execute() {
